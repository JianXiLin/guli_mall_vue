...
export default {
  ...
  methods: {
    addCatelogSelect() {
      ...
      this.$http({
        url: this.$http.adornUrl("/gulimall_product/categorybrandrelation/save"),
        method: "post",
    ...
    getCateRelation() {
      this.$http({
        url: this.$http.adornUrl("/gulimall_product/categorybrandrelation/catelog/list"),
        method: "get",
    ...
    updateBrandStatus(data) {
      ...
      //发送请求修改状态
      this.$http({
        url: this.$http.adornUrl("/gulimall_product/brand/update/status"),
        method: "post",
